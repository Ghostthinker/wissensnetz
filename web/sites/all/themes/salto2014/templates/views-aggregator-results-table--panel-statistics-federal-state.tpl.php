...
<?php if (!empty($summary)) : ?>
  <div class="flex flex-row-center margin-bottom-1em">
    <?php if (!empty($summary)) : ?>
      <div id="dosb-licenses-details"
           class="dosb_license_export_xls-processed"><?php print $summary; ?></div>
    <?php endif ?>
    <?php if (!empty($export_button)) : ?>
      <?php print $export_button; ?>
    <?php endif ?>
  </div>
<?php endif ?>
<table
  ...
  <?php if (!empty($header)) : ?>
    <tr>
      <th><?php print ($header['title']); ?></th>
      <th><?php print ($header['field_ea_training_course']); ?></th>
      <th><?php print ($header['field_ea_sport']); ?></th>
      <th><?php print ($header['field_ea_profile']); ?></th>
      <th><?php print ($header['field_ea_focus']); ?></th>
      <th
        title="männlich"><?php print strtoupper(str_replace(" m ", " männlich ", $header['lid_8'])); ?></th>
      <th
        title="weiblich"><?php print strtoupper(str_replace(" w ", " weiblich ", $header['lid_9'])); ?></th>
      <th
        title="unbekannt"><?php print strtoupper(str_replace(" u ", " unbekannt ", $header['lid_10'])); ?></th>
      <th
        title="gesamt"><?php print strtoupper(str_replace(" g ", " gesamt ", $header['lid_11'])); ?></th>
    </tr>
  <?php endif; ?>
